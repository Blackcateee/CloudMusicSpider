...
class CloudmusicSpider(scrapy.Spider):
    name = 'CloudMusic'
    # webdriver = webdriver.Chrome(executable_path="D:\python\chromedriver.exe")
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            yield scrapy.Request(url, dont_filter=True, callback=self.parse_list, meta={'item_list': item_list})
